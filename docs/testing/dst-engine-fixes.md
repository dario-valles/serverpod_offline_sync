...
| Operation | Baseline `77bb1ef` (ms) | After #138 (ms) |
| --- | ---: | ---: |
| CRUD insert | 82.81 | 84.81 |
| CRUD update | 449.09 | 470.52 |
| Upsert insert | 107.43 | 117.22 |
| Upsert update | 482.84 | 459.21 |
| CRUD delete | 81.32 | 77.50 |
| Merge insert | 191.23 | 217.45 |
| Merge update | 110.06 | 116.30 |
| Merge delete | 81.92 | 86.46 |
| Merge mixed | 126.27 | 137.69 |
| Merge unique conflict | 309.13 | 316.29 |
| Merge original default parent delete/restore | 6.83 | 7.22 |
| Merge default parent delete/restore | 4.35 | 4.69 |
| Merge FK chain insert | 260.07 | 249.89 |
| Merge FK chain delete | 68.76 | 66.80 |
